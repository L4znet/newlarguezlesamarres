...
import { Button, TextInput, Text as TextPaper, useTheme, Switch, ActivityIndicator } from "react-native-paper"
...
export default function selectEquipments() {
     const { removeEquipment, setErrors, getErrors, setEquipments, temporaryEquipments, equipments } = useOfferStore()

     const [newEquipment, setNewEquipment] = useState({ equipmentName: "", equipmentQuantity: "1" })

     const router = useRouter()
     const { backPath, offerId } = useLocalSearchParams<{ backPath: string; offerId: string }>()
